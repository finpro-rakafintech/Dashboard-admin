            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li <?= $this->uri->segment(1)=='view_property' ||  $this->uri->segment(1) == '' ? 'class="active"' :''?>>
                        <a class="nav-link" href="<?=site_url('view_property') ?>">Data Property</a>
                    </li>
                    <li>
                        <a class="nav-link" href="<?=site_url('view_user') ?>">Data User</a>
                    </li>
                    <li>
                        <a class="nav-link" href="<?=site_url('view_nasabah') ?>">Data Nasabah</a>
                    </li>
                </ul>
            </li>
</div>